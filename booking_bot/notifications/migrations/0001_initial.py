    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "template_ru",
                    models.TextField(help_text="Используйте {переменные} для подстановки"),
                ),
                ...
                (
                    "delay_minutes",
                    models.IntegerField(default=0, help_text="Задержка перед отправкой (минуты)"),
                ),
                (
                    "send_to_user",
                    models.BooleanField(default=True, help_text="Отправлять пользователю"),
                ),
                (
                    "send_to_owner",
                    models.BooleanField(default=False, help_text="Отправлять владельцу"),
                ),
                (
                    "send_to_admins",
