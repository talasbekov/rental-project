...
from .views import kaspi_payment_webhook, KaspiInitiatePaymentView # Add new view
...
urlpatterns = [
    ...
    path('kaspi/initiate/', KaspiInitiatePaymentView.as_view(), name='kaspi_initiate_payment'), # New line
]
