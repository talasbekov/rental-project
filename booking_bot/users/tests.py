...
class UserAuthTests(APITestCase):
    def setUp(self):
        ...
        UserProfile.objects.create(user=self.user, role='user', phone_number='+1234567890')

        self.register_url = reverse('user-list') # Assumes 'user-list' is the basename for UserViewSet create action
    ...
    def test_user_registration(self):
        ...
        self.assertTrue(UserProfile.objects.filter(user__username='newuser', phone_number='+9876543210').exists())
